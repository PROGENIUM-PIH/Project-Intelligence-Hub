...
export default async function MarketDetailPage({params}:{params:Promise<{id:string}>}){
  ...
  const market=await prisma.market.findUnique({where:{id},include:{initiatives:{include:{initiative:true}},meetings:{orderBy:{date:"desc"}},documents:{orderBy:{createdAt:"desc"}}}});
  if(!market)notFound();
