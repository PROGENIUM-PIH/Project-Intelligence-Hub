...
export function TopNav() {
  ...
  return <header className="pih-topnav sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-card px-4 lg:px-8">
    ...
    <div className="ml-auto flex items-center gap-3"><Avatar className="h-8 w-8"><AvatarFallback className="bg-primary text-xs text-primary-foreground">LB</AvatarFallback></Avatar></div>
  </header>;
}
