...
export default async function InitiativesPage() {
  ...
  return <div>
    <div className="mb-6 flex flex-wrap items-start justify-between gap-4"><PageHeader title="Initiatives" description="Workstreams driving the global sales transformation program." /><Link href="/updates"><Button className="bg-[#78FAAE] text-[#0D3B32] hover:bg-[#78FAAE]/90"><Upload className="h-4 w-4"/>Upload files</Button></Link></div>
