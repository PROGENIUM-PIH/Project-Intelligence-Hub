...
export default async function MarketDetailPage({params}:{params:Promise<{id:string}>}){
  ...
  const [market, allInitiatives]=await Promise.all([
    prisma.market.findUnique({where:{id},include:{initiatives:{include:{initiative:true}},meetings:{orderBy:{date:"desc"}},documents:{orderBy:{createdAt:"desc"}},notes:{orderBy:{createdAt:"desc"},include:{initiative:true}}}}),
